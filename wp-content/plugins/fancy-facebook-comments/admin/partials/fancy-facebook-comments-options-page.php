...
<div class="metabox-holder columns-2" id="post-body">
		...
		<div class="menu_div" id="tabs">
				...
				<div class="stuffbox">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
						...
						<tr>
							...
							<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank"><img style="width:100%;" src="<?php echo plugins_url( '../../images/snaps/Fancy Facebook Comments - Logged in Users.png', __FILE__ ) ?>" /></a>
							</td>
						</tr>
			...
			<div class="menu_containt_div" id="tabs-6">
				<div class="clear"></div>
				<div class="heateor_ffc_left_column">
					<a href="https://www.heateor.com/fancy-facebook-comments-pro" target="_blank"><img style="width:86%" src="<?php echo plugins_url( '../../images/snaps/Fancy Facebook Comments - Recent Facebook Comments.png', __FILE__ ) ?>" /></a>
				</div>
				<?php include 'fancy-facebook-comments-about.php'; ?>
			</div>
