...
####The original "**Booking Calendar**" plugin is the 1st booking system for WordPress, **downloaded over 2,500,000** times [since 2009](https://wpbookingcalendar.com/changelog/).
...
= KEY BENEFITS: =
- **NEW** Super **easy set available/unavailable dates** in calendar with just three mouse clicks.
...
= FEATURES: =
- **Easily set available/unavailable dates**
- In Booking Calendar you can define days as available or unavailable in just a few clicks.
- Simply select a range of days on the calendar, choose 'available' or 'unavailable' status, and apply.
- It's that simple!
...
== Screenshots ==
1. **Calendar Availability**. Super easy set available / unavailable dates in calendar with 3 mouse clicks.
2. **Booking Listing** panel. Search bookings by keyword or dates and manage them instantly, without page reloading.
...
== Upgrade Notice ==
= 9.5 =
New super easy configuration of dates availability with 3 mouse clicks in modern and intuitive interface with instant responses.